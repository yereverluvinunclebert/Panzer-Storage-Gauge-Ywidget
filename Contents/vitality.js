...
function buildVitality(bg, perc) {
    ...
    x.setAttribute("hOffset", "05");
    x.setAttribute("vOffset", "25");
    x.setAttribute("hAlign", "left");
    x.setAttribute("style", "text-align: left;font-family: 'Times New Roman'; font-stretch: condensed; font-size: 12px; color: #0d0d0d; ");
